...
#' \code{factor(press)} in the model formula, or \code{dressing$press <-
#' factor(dressing$press)} prior to calling the modelling function.
#' 
#' @name dressing
#' @docType data
#' @format A data frame with 29 observations on the following 7 variables.
#' \describe{ \item{list("press")}{a numeric vector with values 75, 125 and
#' 225.  The homogenisation pressure.} \item{list("stab")}{a numeric vector
#' with values 0.3, 0.4 and 0.5.  Amount of stabiliser.} \item{list("emul")}{a
#' numeric vector with values 0.1, 0.2 and 0.35.  Amount of emulsifier.}
#' \item{list("day")}{a factor with levels \code{1}, \dots{}, \code{5}.  The
#' day the experimental run was performed on.} \item{list("visc")}{a numeric
#' vector.  The measured viscosity of the dressing.} \item{list("rheo")}{a
...
#' \item{list("pvol")}{a matrix with 241 columns.  Particle-volume curves.
